...
module.exports = function(homebridge) {
  	...
  	homebridge.registerAccessory("homebridge-mqttswitch-RfBridge", "mqttswitch", mqttswitchAccessory);
}
...
mqttswitchAccessory.prototype.setStatus = function(status, callback, context) {
	if(context !== 'fromSetValue') {
        ...
        this.client.publish(status ? this.topics.setOn : this.topics.setOff, status ? this.onValue : this.offValue);
	}
	callback();
}
...
/*mqttswitchAccessory.prototype.getHue = function(callback) {
    callback(null, this.hue);
}

mqttswitchAccessory.prototype.setHue = function(hue, callback, context) {
	if(context !== 'fromSetValue') {
		this.hue = hue;
...
mqttswitchAccessory.prototype.setSaturation = function(saturation, callback, context) {
	if(context !== 'fromSetValue') {
